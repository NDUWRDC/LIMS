...
/**
 *  \file       htdocs/core/modules/lims/mod_limits_standard.php
 *  \ingroup    lims
 ...
 */
class mod_limits_standard extends ModeleNumRefLimits
{
	/**
	...
	public function canBeActivated($object)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."lims_limits";
	...
	public function getNextValue($object)
	{
		...
		{
			dol_syslog("mod_limits_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_limits_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
