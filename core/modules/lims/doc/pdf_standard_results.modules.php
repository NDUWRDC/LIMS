...
/**
 *	Class to manage PDF template standard_results
 */
class pdf_standard_results extends ModelePDFResults
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_RESULTS_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->lims->dir_output.'/results')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->lims->dir_output.'/results';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->lims->dir_output.'/results/'.$objectref;
