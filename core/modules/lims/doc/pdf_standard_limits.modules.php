...
/**
 *	Class to manage PDF template standard_limits
 */
class pdf_standard_limits extends ModelePDFLimits
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_LIMITS_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->lims->dir_output.'/limits')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->lims->dir_output.'/limits';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->lims->dir_output.'/limits/'.$objectref;
