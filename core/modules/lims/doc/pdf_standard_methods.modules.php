...
/**
 *	Class to manage PDF template standard_methods
 */
class pdf_standard_methods extends ModelePDFMethods
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_METHODS_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->lims->dir_output.'/methods')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->lims->dir_output.'/methods';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->lims->dir_output.'/methods/'.$objectref;
