...
/**
 *	Class to manage PDF template standard_samples
 */
class pdf_standard_samples extends ModelePDFSamples
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_SAMPLES_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->lims->dir_output.'/samples')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->lims->dir_output.'/samples';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->lims->dir_output.'/samples/'.$objectref;
