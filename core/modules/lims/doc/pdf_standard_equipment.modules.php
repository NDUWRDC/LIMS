...
/**
 *  \file       core/modules/lims/doc/pdf_standard.modules.php
 *  \ingroup    lims
...
/**
 *	Class to manage PDF template standard_equipment
 */
class pdf_standard_equipment extends ModelePDFEquipment
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_EQUIPMENT_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->lims->dir_output.'/equipment')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->lims->dir_output.'/equipment';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->lims->dir_output.'/equipment/'.$objectref;
