...
/**
 * \file    test/functional/LIMSFunctionalTest.php
 * \ingroup lims
 ...
 * @package Testlims
 */
class LIMSFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/lims/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('lims/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/lims/admin/about.php');
		$this->authenticate();
		return $this->assertContains('lims/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('limswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modLIMS_LIMSTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLIMS_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
