...
if ($action == 'create')
{
	print load_fiche_titre($langs->trans("NewObject", $langs->transnoentitiesnoconv("Limits")));
...
{
	print load_fiche_titre($langs->trans("Limits"));
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	dol_fiche_head($head, 'card', $langs->trans("Limits"), -1, $object->picto);
	...
	/*
	// Ref bis
	$morehtmlref.=$form->editfieldkey("RefBis", 'ref_client', $object->ref_client, $object, $user->rights->lims->limits->creer, 'string', '', 0, 1);
	$morehtmlref.=$form->editfieldval("RefBis", 'ref_client', $object->ref_client, $object, $user->rights->lims->limits->creer, 'string', '', null, null, '', 1);
	// Thirdparty
	...
	*/
	...
	if ($action != 'presend')
	{
	    ...
	    $delallowed = $user->rights->lims->limits->create;	// If you can create/edit, you can remove a file on card
