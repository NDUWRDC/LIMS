...
/**
 *  \file       samples_note.php
 *  \ingroup    lims
 *  \brief      Tab for notes on Samples
 */
...
$hookmanager->initHooks(array('samplesnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Samples'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Samples"), -1, $object->picto);
